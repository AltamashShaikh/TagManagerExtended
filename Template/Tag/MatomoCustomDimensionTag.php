...
class MatomoCustomDimensionTag extends BaseTag
{
    ...
    {
        return array(
            $this->makeSetting('index', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MatomoCustomDimensionTagIndexTitle');
                $field->description = Piwik::translate('TagManagerExtended_MatomoCustomDimensionTagIndexDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),

            $this->makeSetting('value', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MatomoCustomDimensionTagValueTitle');
                $field->description = Piwik::translate('TagManagerExtended_MatomoCustomDimensionTagValueDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),
